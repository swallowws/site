...
(function() {
    ...
    var s, C = document,
        ...
        Xa, bb, Sb = {},
        Ab = 0,
        hb, G, ra, Ba, Bb, A, ta = function() {},
        da = [],
        Ua = "div",
        X = "none",
        Zb = /^[0-9]+$/,
        Tb = "stroke-width",
        ib, La, ub, vb, wb, Va, jb, kb, Mb, Nb, xb, Ob, Pb, H = {},
        ...
        function(a, b, c) {
            ...
            var a = n(a, "%Y-%m-%d %H:%M:%S"),
                ...
                d = u({
                    ...
                    Y: k,
                    H: Ra(f),
		    I: f,				// pretty hack to show the time in 24h format
		    l: f,				// pretty hack to show the time in 24h format
//                    I: Ra(f % 12 || 12),
//                    l: f % 12 || 12,
                    M: Ra(d[ub]()),
		    p: "",				// pretty hack to show the time in 24h format
		    P: "",				// pretty hack to show the time in 24h format
//                    p: f < 12 ? "AM" : "PM",
//                    P: f < 12 ? "am" : "pm",
                    S: Ra(d.getSeconds()),
    ...
    Bb = {
        ...
        step: function(a, b, c, d) {
            ...
            if (c === 1) e = d;
                ...
                for (; f--;) d = parseFloat(a[f]), e[f] = isNaN(d) ? a[f] : c * parseFloat(b[f] -
                    d) + d;
            else e = b;
            return e
        }
    ...
    G = {
        ...
        lang: {
            ...
            shortMonths: "Янв.,Фев.,Мар.,Апр.,Май,Июнь,Июль,Авг.,Сент.,Окт.,Нояб.,Дек.".split(","),
    ...
    Ca.prototype = {
        ...
        attr: function(a, b) {
            ...
            if (ka(a)) c = a, h === "circle" ? c = {
                x: "cx",
                y: "cy"
            }[c] || c : c === "strokeWidth" && (c = "stroke-width"), p = I(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && c !== "fill" && (p = parseFloat(p));
            else {
                for (c in a)
                    if (k = !1, d = a[c], e = j[c] && j[c].call(this, d, c), e !== !1) {
                        ...
                        if (c === "d") d && d.join && (d = d.join(" ")), /(NaN| {2}|^$)/.test(d) && (d = "M 0 0");
                            ...
                            for (e = 0; e < g.childNodes.length; e++) f = g.childNodes[e], I(f, "x") === I(g, "x") && I(f, "x", d);
                            ...
                            if (c = "stroke-dasharray", d = d && d.toLowerCase(), d === "solid") d = X;
                            else {
                                if (d) {
                        ...
                        else if (c === "title") e = g.getElementsByTagName("title")[0], e || (e = C.createElementNS(Na, "title"), g.appendChild(e)), e.textContent = d;
                        ...
                        if (l && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(c))
                            for (e = l.length; e--;) I(l[e], c, c === "height" ? v(d - (l[e].cutHeight || 0), 0) : d);
        ...
        css: function(a) {
            ...
            if (b)
                for (f in a) a[f] !== b[f] && (c[f] = a[f],
                    e = !0);
            if (e) {
                e = this.textWidth = a && a.width && d.nodeName.
                toLowerCase() === "text" && y(a.width);
                b && (a = u(b, c));
                this.styles = a;
    ...
    ha.prototype = {
                ...
                q(l, function(e) {
                    if (e !== "" || l.length === 1) {
                        ...
                        if (e !== " " && (n.appendChild(C.createTextNode(e)), m ? p.dx = 0 : p.x = i, I(n, p), !m && f && (!$ && d && J(n, {
                                display: "block"
                            }), I(n, "dy", o(n), mb && n.offsetHeight)), b.appendChild(n), m++, j))
                            for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "),
                                    p = e.length > 1 && k.whiteSpace !== "nowrap", s, r, t = a._clipHeight, E = [], v = o(), u = 1; p && (e.length || E.length);) delete a.bBox, s = a.getBBox(), r = s.width, !$ && c.forExport && (r = c.measureSpanWidth(n.firstChild.data, a.styles)), s = r > j, !s || e.length === 1 ? (e = E, E = [], e.length && (u++, t && u * v > t ? (e = ["..."], a.attr("title", a.textStr)) : (n = C.createElementNS(Na, "tspan"), I(n, {
                                dy: v,
                                x: i
                            }), q && I(n, "style", q), b.appendChild(n), r > j && (j = r)))) : (n.removeChild(n.firstChild), E.unshift(e.pop())), e.length && n.appendChild(C.createTextNode(e.join(" ").replace(/- /g,
                                "-")))
                    }
                })
            })
        ...
        symbol: function(a, b, c, d, e, f) {
            ...
            }, k = a.match(i)[1], a = Sb[k], g = this.image(k).attr({
                x: b,
                y: c
    ...
    if (!$ && !ga) Q.VMLElement = pa = {
        ...
        attr: function(a, b) {
            var c, d, e, f = this.element || {},
                ...
                p = this;
            ka(a) && r(b) && (c = a, a = {}, a[c] = b);
            if (ka(a)) c = a, p = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c];
            else
                for (c in a)
                    if (d = a[c], m = !1, e = o[c] && o[c].call(this, d, c), e !== !1 && d !== null) {
                        ...
                        else if (ua(c, ["x", "y", "width", "height"]) !== -1) this[c] = d, c === "x" || c === "y" ? c = {
                            x: "left",
                            y: "top"
                        }[c] : d = v(0, d), this.updateClipping ? (this[c] = d, this.updateClipping()) : g[c] = d, m = !0;
                        else if (c === "class" && h === "DIV") f.className = d;
                        else if (c === "stroke") d = i.color(d, f, c), c = "strokecolor";
                        else if (c === "stroke-width" || c === "strokeWidth") f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, za(d) && (d += "px");
                        ...
                        else if (h === "shape" && c === "rotation") this[c] = f.style[c] = d, f.style.left = -t(fa(d * Ma) + 1) + "px", f.style.top = t(aa(d *
                            Ma)) + "px";
        ...
        color: function(a, b, c, d) {
            ...
            if (i) {
                ...
                if (c === "fill")
                    if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, K = 'angle="' + (90 - W.atan((m - a) / (o - c)) * 180 / oa) + '"', t();
                    else {
                        var k = m.r,
                            v = k * 2,
                            u = k * 2,
            ...
            } else if (g.test(a) && b.tagName !== "IMG") f = Ea(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], Y(this.prepVML(h), null, null, b), k = f.get("rgb");
            else {
    ...
    $a.prototype = {
        ...
        render: function(a, b, c) {
            ...
            if (m && z) r === "inside" && (z = -z), d.opposite && (z = -z), h = this.getMarkPath(x, w, z, m * E, g, f), o ? o.animate({
                d: h,
                opacity: c
    ...
    N.prototype = {
        ...
        defaultLabelFormatter: function() {
            ...
            if (h) g = Ja(h, this);
                ...
                for (; f-- && g === s;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Ia(b / c, -1) + e[f]);
        ...
        render: function() {
            ...
            if (t || h)
                if (a.minorTickInterval && !a.categories && q(a.getMinorTickPositions(), function(b) {
                        ...
                        if (c % 2 === 0 && b < a.max) o[b] || (o[b] = new Q.PlotLineOrBand(a)), u = b + n, y = i[c + 1] !== s ? i[c + 1] + n : a.max, o[b].options = {
                            from: g ?
                                la(u) : u,
                            to: g ? la(y) : y,
                            color: B
            ...
            if (z) b = a.getLinePath(z), a.axisLine ? a.axisLine.animate({
                    d: b
                }) :
        ...
        drawCrosshair: function(a, b) {
            if (this.crosshair)
                if ((r(b) || !n(this.crosshair.snap, !0)) === !1) this.hideCrosshair();
                else {
    ...
    Ya.prototype = {
        ...
        runPointActions: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                ...
                i = c.length;
                for (k = 0; k < i; k++)
                    if (c[k].visible && c[k].options.enableMouseTracking !== !1 && !c[k].noSharedTooltip && c[k].singularTooltips !== !0 && c[k].tooltipPoints.length && (e = c[k].tooltipPoints[l]) && e.series) e._dist = O(l - e.clientX), j = x(j, e._dist), f.push(e);
        ...
        onContainerClick: function(a) {
            ...
            a.cancelBubble = !0;
            if (!b.cancelClick) c &&
                this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, u(c, {
    ...
    if (U.PointerEvent || U.MSPointerEvent) {
        var wa = {},
            ...
            Ib = function(a, b, c, d) {
                a = a.originalEvent || a;
                if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && da[ja]) d(a), d = da[ja].pointer, d[b]({
                    type: c,
    ...
    pb.prototype = {
        ...
        colorizeItem: function(a, b) {
            ...
            if (f) {
                if (g && f.isMarker)
                    for (k in g = a.convertAttribs(g), g) d = g[k], d !== s && (i[k] = d);
                f.attr(i)
            }
        },
        ...
        renderItem: function(a) {
            ...
            if (!q) a.legendGroup = c.g("legend-item").attr({
                zIndex: 1
            }).add(this.scrollGroup), z.drawLegendSymbol(this, a), a.legendItem = q = c.text(d.labelFormat ? Ja(d.labelFormat, a) : d.labelFormatter.call(a),
                l ? f + g : -g, this.baseline, r).css(w(a.visible ? h : i)).attr({
                align: l ? "left" : "right",
                zIndex: 2
            }).add(a.legendGroup), this.setItemEvents && this.setItemEvents(a, q, r, h, i), this.colorizeItem(a, a.visible), s && this.createCheckboxForItem(a);
            c = q.getBBox();
        ...
        scroll: function(a, b) {
            var c = this.pages,
                ...
                k = this.padding;
            e > d && (e = d);
            if (e > 0) b !== s && Za(b, this.chart), this.nav.attr({
                translateX: k,
    ...
    M.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData) q(a, function(a, b) {
                ...
                if (p && h > p) {
                    ...
                    if (za(j)) {
                        ...
                        if (z)
                            for (c = 0; c < h; c++) i = a[c], B[c] = i[0], Oa[c] = i.slice(1, z + 1);
                        else
                            for (c = 0; c < h; c++) i = a[c], B[c] = i[0], Oa[c] = i[1];
                    else na(12)
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== s && (i = {
        ...
        generatePoints: function() {
            ...
            if (b && (g !== (c = b.length) || k))
                for (m = 0; m < c; m++)
                    if (m === h && !k && (m += g), b[m]) b[m].destroyElements(), b[m].plotX = s;
            this.data = b;
            this.points = l
        },
    ...
    M.prototype.setPercentStacks = function() {
        ...
        q([b, "-" + b], function(b) {
            ...
            for (var f = d.length, g, h; f--;)
                if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index], g = e) h = h.total ? 100 / h.total : 0, g[0] = ea(g[0] * h), g[1] = ea(g[1] * h), a.stackedYData[f] = g[1]
        })
    };
    u(sa.prototype, {
    ...
    var qa = ca(M, {
        ...
        getSegmentPath: function(a) {
            ...
            if (e.stacking && !this.closedStacks)
                for (d = a.length - 1; d >= 0; d--) g = n(a[d].yBottom, f), d < a.length - 1 && e.step && c.push(a[d + 1].plotX, g), c.push(a[d].plotX, g);
    ...
    ya = ca(M, {
        ...
        drawPoints: function() {
            ...
            q(a.points, function(f) {
                var g = f.plotY,
                    h = f.graphic;
                if (g !== s && !isNaN(g) && f.y !== null) e = f.shapeArgs, h ? (eb(h), h[a.points.length < d ? "animate" : "attr"](w(e))) : f.graphic = c[f.shapeType](e).attr(f.pointAttr[f.selected ? "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius);
    ...
    M.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (a = this.visible && (a.series.forceDL || f.isInsidePlot(h,
                t(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g))) d = u({
            x: g ? f.plotWidth - i : h,
    ...
    if (H.pie) H.pie.prototype.drawDataLabels = function() {
        var a = this,
            ...
            f = n(e.connectorPadding,
                10),
            g = n(e.connectorWidth, 1),
            h = d.plotWidth,
            d = d.plotHeight,
            i, k, j = n(e.softConnector, !0),
            l = e.distance,
            m = a.center,
            o = m[2] / 2,
            p = m[1],
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                if (l >
                    ...
                    for (E = 0; E < G; E++) {
                        ...
                        if (F < E && b[E] !== null) F = E;
                            ...
                            for (z < G - E + F && b[E] !== null && (F = z - G + E); b[F] === null;) F++;
                        I.push({
                            i: F,
                            y: b[F]
                        });
            ...
            if (Aa(A) === 0 || this.verifyDataLabelOverflow(A)) this.placeDataLabels(), B && g && q(this.points, function(b) {
                i =
                    b.connector;
                r = b.labelPos;
                if ((s = b.dataLabel) && s._pos) D = s._attr.visibility, x = s.connX, y = s.connY, k = j ? ["M", x + (r[6] === "left" ? 5 : -5), y, "C", x, y, 2 * r[2] - r[4], 2 * r[3] - r[5], r[2], r[3], "L", r[4], r[5]] : ["M", x + (r[6] === "left" ? 5 : -5), y, "L", r[2], r[3], "L", r[4], r[5]], i ? (i.animate({
                    d: k
    ...
    u(xa.prototype, {
        ...
        setState: function(a, b) {
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && !i.enabled) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                if (this.graphic) f = g && this.graphic.symbolName && o[a].r, this.graphic.attr(w(o[a], f ? {
                    x: c -
                        f,
                    y: d - f,
                    width: 2 * f,
                    ...
                    if (a && i)
                        if (f = i.radius, l = l.symbol || e.symbol, j && j.currentSymbol !== l && (j = j.destroy()), j) j[b ? "animate" : "attr"]({
                            x: c - f,
                            y: d - f
                        });
                        else e.stateMarkerGraphic = j = m.renderer.symbol(l, c - f, d - f, 2 * f, 2 * f).attr(o[a]).add(e.markerGroup), j.currentSymbol = l;
        ...
        if (c.options.ordinal && c.series.length) {
            ...
            if (m.ordinalPositions) {
                if (O(f) > 1) j && q(j, function(a) {
                    a.setState()
                }), f < 0 ? (j = m, p = c.ordinalPositions ? c : m) : (j = c.ordinalPositions ? c : m, p = m), m = p.ordinalPositions, h > m[m.length - 1] && m.push(h), this.fixedRange = k - i, f = c.toFixedRange(null, null, l.apply(j, [o.apply(j, [i, !0]) + f, !0]), l.apply(p, [o.apply(p, [k, !0]) + f, !0])), f.min >= x(g.dataMin, i) && f.max <= v(h, k) && c.setExtremes(f.min, f.max, !0, !1, {
                    trigger: "pan"
    ...
    var Z = M.prototype,
        ...
        kc = {
            ...
            groupPixelWidth: 2,
            dateTimeLabelFormats: Jb("millisecond", ["%A, %b %e, %H:%M:%S.%L",
    ...
    Z.groupData = function(a, b, c, d) {
        ...
        for (; n <= i; n++) {
            for (; c[1] !== s && a[n] >= c[1] || n === i;)
                if (k = c.shift(), j = d.apply(0, m), j !== s && (g.push(k), h.push(j)), m[0] = [], m[1] = [], m[2] = [], m[3] = [], n === i) break;
            if (n === i) break;
            if (o) {
                k = this.cropStart + n;
                k = e && e[k] ||
                ...
                var q;
                for (j = 0; j < p; j++)
                    if (q = k[o[j]], typeof q === "number") m[j].push(q);
    ...
    L = ca(H.column, {
        ...
        drawPoints: function() {
            ...
            q(a.points, function(j) {
                if (j.plotY !== s) i = j.graphic, c = j.pointAttr[j.selected ? "selected" : ""], f = c["stroke-width"] % 2 / 2, k = t(j.plotX) - f, g = t(j.shapeArgs.width / 2), h = ["M", k, t(j.yBottom), "L", k, t(j.plotY)], j.open !== null && (d = t(j.plotOpen) + f, h.push("M", k, d, "L", k - g, d)), j.close !== null && (e = t(j.plotClose) + f, h.push("M", k, e, "L", k + g, e)), i ? i.animate({
                    d: h
    ...
    L = ca(L, {
        ...
        drawPoints: function() {
            var a = this,
                b = a.chart,
                c, d = a.pointAttr[""],
                e, f, g, h, i, k, j, l, m, o, p;
            q(a.points, function(n) {
                m = n.graphic;
                if (n.plotY !== s) c = n.pointAttr[n.selected ? "selected" : ""] ||
                    d, j = c["stroke-width"] % 2 / 2, l = t(n.plotX) - j, e = n.plotOpen, f = n.plotClose, g = W.min(e, f), h = W.max(e, f), p = t(n.shapeArgs.width / 2), i = t(g) !== t(n.plotY), k = h !== n.yBottom, g = t(g) + j, h = t(h) + j, o = ["M", l - p, h, "L", l - p, g, "L", l + p, g, "L", l + p, h, "Z", "M", l, g, "L", l, i ? t(n.plotY) : g, "M", l, h, "L", l, k ? t(n.yBottom) : h, "Z"], m ? m.animate({
                        d: o
    ...
    H.flags = ca(H.column, {
        ...
        drawPoints: function() {
            var a, b = this.pointAttr[""],
                ...
                e, f, g = this.options,
                h = g.y,
                i, k, j, l, m = g.lineWidth % 2 / 2,
                o, n;
            for (k = c.length; k--;)
                if (j = c[k], a = j.plotX > this.xAxis.len, e = j.plotX + (a ? m : -m), l = j.stackIndex, i = j.options.shape || g.shape, f = j.plotY, f !== s && (f = j.plotY + h +
                        m - (l !== s && l * g.stackDistance)), o = l ? s : j.plotX + m, n = l ? s : j.plotY, l = j.graphic, f !== s && e >= 0 && !a) a = j.pointAttr[j.selected ? "select" : ""] || b, l ? l.attr({
                    x: e,
                    y: f,
                    r: a.r,
                    anchorX: o,
    ...
    yb.prototype = {
                ...
                if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    if (!this.rendered) {
                        if (C) this.navigatorGroup = l = f.g("navigator").attr({
                            ...
                            fill: s.maskFill
                        }).add(l), this.rightShade = f.rect().attr({
                            fill: s.maskFill
                        }).add(l), this.outline = f.path().attr({
                            "stroke-width": D,
                            stroke: s.outlineColor
                        }).add(l);
                        if (q) this.scrollbarGroup = j = f.g("scrollbar").add(), m = r.trackBorderWidth, this.scrollbarTrack = o = f.rect().attr({
                            x: 0,
                            y: -m % 2 / 2,
                    ...
                    if (q && j) this.drawScrollbarButton(0), this.drawScrollbarButton(1), j[e]({
                        ...
                        width: k
                    }), g = p + b, h = a - H, h < u && (F = (u - h) / 2, h = u, g -= F), this.scrollbarPad = F, m[e]({
                        x: T(g) + H % 2 / 2,
                        width: h
                    }), u = p + b + a / 2 - 0.5, this.scrollbarRifles.attr({
        ...
        init: function() {
            ...
            a.mouseDownHandler = function(d) {
                var d = b.pointer.normalize(d),
                    ...
                    u, v = db ? 10 : 7;
                if (t > h && t < h + g + k)
                    if ((h = !a.scrollbarEnabled || t < h + g) && W.abs(r - e - n) < v) a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null;
                    else if (h && W.abs(r - f - n) < v) a.grabbedRight = !0, a.otherHandlePos =
                    ...
                    if (f < 0) f = 0;
                    else if (f + s >= p) f = p - s, u = c.dataMax;
                    if (f !== e) a.fixedWidth = s, e = c.toFixedRange(f, f + s, null, u), d.setExtremes(e.min, e.max, !0, !1, {
                        trigger: "navigator"
                    })
                }
            };
            ...
            a.navigatorEnabled ? (a.xAxis = c = new N(b, w({
                ...
                index: p,
                zoomEnabled: !1
            })), m || f.series.data ? a.addBaseSeries() : b.series.length === 0 && R(b, "redraw", function(c, d) {
        ...
        addBaseSeries: function() {
            ...
            if (a && this.navigatorOptions.adaptToUpdatedData !== !1) D(a, "updatedData", this.updatedDataHandler), a.userOptions.events = u(a.userOptions.event, {
        ...
        destroy: function() {
            ...
            q([this.xAxis, this.yAxis,
                this.leftShade, this.rightShade, this.outline, this.scrollbarTrack, this.scrollbarRifles, this.scrollbarGroup, this.scrollbar
            ], function(a) {
    ...
    zb.prototype = {
        clickButton: function(a, b) {
            var c = this,
                ...
                h = e.xAxis[0],
                i = e.scroller &&
                e.scroller.getUnionExtremes() || h || {},
                k = i.dataMin,
                j = i.dataMax,
                l, m = h && t(x(h.max, n(j, h.max))),
                o = new Date(m),
                p = g.type,
                r = g.count,
                i = g._range,
            ...
            if (!(k === null || j === null || a === c.selected)) {
                if (p === "month" || p === "year") l = {
                    month: "Month",
                    year: "FullYear"
                }[p], o["set" + l](o["get" + l]() - r), l = o.getTime(), k = n(k, Number.MIN_VALUE), isNaN(l) || l < k ? (l = k, m = x(l + i, j)) : i = m - l;
                else if (i) l = v(m - i, k), m = x(l + i, j);
                else if (p === "ytd")
                    if (h) {
        ...
        drawInput: function(a) {
            ...
            i.onchange = function() {
                ...
                isNaN(d) || (G.global.useUTC || (d += (new Date).getTimezoneOffset() * 6E4), h ? d > b.maxInput.HCTime ? d = s : d < g && (d = g) : d < b.minInput.HCTime ? d = s : d > j && (d = j),
                    d !== s && c.xAxis[0].setExtremes(h ? d : e.min, h ? e.max : d, s, s, {
    ...
    N.prototype.getPlotLinePath = function(a, b, c, d, e) {
        var f = this,
            ...
            k = f.top,
            j, l, m, o, p = [],
            g = this.isXAxis ? r(this.options.yAxis) ? [this.chart.yAxis[this.options.yAxis]] : va(g, function(a) {
                return a.yAxis
